...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse createProduct(ProductRequest productRequest) {
        Product product = Product.builder()
                ...
                .status(productRequest.getStatus() == null ? com.freshmart.model.enums.ProductStatus.IN_STOCK : productRequest.getStatus())
                .build();
    ...
    @Override
    public ProductResponse updateProductStatus(Long id, com.freshmart.model.enums.ProductStatus status) {
        Product product = productRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Sản phẩm", id));
